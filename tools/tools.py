...
BUILTIN_TOOLS = [
    ...
    {"type": "function", "function": {"name": "compact",
     ...
     "parameters": {"type": "object",
                    ...
                    "required": []}}},
    {"type": "function", "function": {"name": "create_task", "description": "Create a task.",
     "parameters": {"type": "object",
    ...
    {"type": "function", "function": {"name": "send_message", "description": "Send message to a teammate.",
     "parameters": {"type": "object",
                    "properties": {"to": {"type": "string"},
                                   "content": {"type": "string"}},
                    "required": ["to", "content"]}}},
    {"type": "function", "function": {"name": "check_inbox",
    ...
    {"type": "function", "function": {"name": "create_worktree",
     ...
     "parameters": {"type": "object",
                    "properties": {"name": {"type": "string"},
                                   "task_id": {"type": "string"}},
                    "required": ["name"]}}},
    {"type": "function", "function": {"name": "remove_worktree",
     "description": "Remove a worktree. Refuses if changes exist.",
     "parameters": {"type": "object",
                    "properties": {"name": {"type": "string"},
                                   "discard_changes": {"type": "boolean"}},
                    "required": ["name"]}}},
    {"type": "function", "function": {"name": "keep_worktree",
...
def run_spawn_teammate(name: str, role: str, prompt: str) -> str:
    from tasks.workers import spawn_teammate_thread
...
def run_connect_mcp(name: str) -> str:
    from tools.mcp_connector import connect_mcp
...
def run_request_shutdown(teammate: str) -> str:
    BUS.send("lead", teammate, "Please shut down.",
             ...
             metadata={"request_id": new_request_id()})
    return f"Shutdown requested for {teammate}"


def run_request_plan(teammate: str, task: str) -> str:
    BUS.send("lead", teammate, task,
